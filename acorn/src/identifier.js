...
// 用于匹配非 ASCII 字符的正则
// 根据 JS 标准，合法的标识符由 Unicode® Standard Annex #31（https://www.unicode.org/reports/tr31/tr31-29.html）给出
...
// 判断一个 charCode 是否为一个标识符的开始
// 非 ASCII 字符也要处理，因为
//   var 王子龙 = 'Hello World';
//   console.log(王子龙);
// 这样的代码也是合法的
// 超出 0xffff 后的码点，由 isInAstralSet 函数来判断是否是一个合法的代理对（surrogate pair）
...
export function isIdentifierChar(code, astral) {
  ...
  if (code < 58) return true  // 匹配到的是数字
